...
namespace ClientMVC.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(IWebHostEnvironment env, IHttpContextAccessor httpContextAccessor) {
        ...
        public ActionResult Index(string search, double distance = -1)
        {
            ...
            int userId = (int)_loggedInUserId;
        ...
        public ActionResult Show(int id)
        {
            ...
            var fileController = new FileController(_env);
            ...
            model.LoggedInUserId = (int)_loggedInUserId;
        ...
        {
            if (_loggedInUserId == null || (int)_loggedInUserId != id)
            {
                return View("Error");
            }
        ...
        [HttpPost]
        public ActionResult SaveFile(int id, string type, IFormFile file)
        {
            if (_loggedInUserId == null || (int)_loggedInUserId != id)
            {
                return View("Error");
